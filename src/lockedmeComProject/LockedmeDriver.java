	...
	public static void main(String[] args) throws IOException {
		...
		case 2:
			...
			case 1:
				...
				String path = new String("D://Vishal//Full Stack Java Developer//FileSystem//");
			...
			case 2:
				...
				try {
					Files.deleteIfExists(Paths
							.get("D://Vishal//Full Stack Java Developer//FileSystem//"+userName+".txt"));
			...
			case 3:
				...
				File file = getUserFile("D://Vishal//Full Stack Java Developer//FileSystem//", "vishal.txt");
				if (!(file == null)) {
...
//  
	...
	public static File getUserFile(String path, String fileName) {
		new String("D://Vishal//Full Stack Java Developer//FileSystem");
		File file = new File(path);
		File getDirectory[] = file.listFiles();
//			Arrays.sort(getDirectory);
